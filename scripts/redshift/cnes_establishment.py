...
class CnesEstablishment():
    ...
    def open_df(self):
        self.df = pd.read_csv(
            ...
            sep=',',
            header=0,
            names=['cnes', 'tp_unid', 'codmun', 'vinc_sus', 'tp_prest', 'nivate_a', 'nivate_h', 'urgemerg', 'atendamb', 'centrcir',
                'centrobs', 'centrneo', 'atendhos', 'coletres', 'niv_dep1', 'regsaude', 'esfera', 'retencao_2', 'niv_hier_2', 'competen1'
            ],
            converters={
                'cnes': str,
                'tp_unid': str,
